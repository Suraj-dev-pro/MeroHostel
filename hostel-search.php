...
<section class="hostel-search text-center">
    <div class="container">
        ...
        ?>
        <legend class="text-search">Hostel result based on your Keyword:<h2><?php echo $search; ?></h2>
        </legend>
    </div>
</section>
...
<section class="hostel-menu">
    <div class="container">
        ...
        $sql = "SELECT * FROM hostels WHERE (name LIKE '%$search%' OR address LIKE '%$search%' OR type LIKE '%$search%') and booked='no'";
